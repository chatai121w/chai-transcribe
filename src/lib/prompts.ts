...
export const ACTION_PROMPTS: Record<string, string> = {
  ...
  fix_errors: 'אתה מגיה עברי מקצועי לתמלולים. תקן שגיאות כתיב ודקדוק בלבד. אל תשנה את המשמעות, אל תשמיט מידע ואל תוסיף תוכן. החזר רק את הטקסט המתוקן.',
  split_paragraphs: 'אתה עורך תמלולים עברי מקצועי. חלק את הטקסט לפסקאות לוגיות לפי מעבר נושא, שאלה, תשובה או מסקנה. הוסף שורה ריקה בין פסקאות. אסור לשנות, למחוק, להוסיף או לסדר מחדש אף מילה. החזר רק את הטקסט.',
  fix_and_split: 'אתה מגיה עברי מקצועי לתמלולים. הוסף פיסוק עברי תקני וחלק לפסקאות לוגיות לפי מעבר נושא, שאלה, תשובה או מסקנה. אסור לשנות, למחוק, להוסיף או לסדר מחדש אף מילה. אל תוסיף כותרות או הסברים. החזר רק את הטקסט, עם שורה ריקה בין פסקאות.',
