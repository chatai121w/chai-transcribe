...
```json
{"id":"lesson-001-0001","audio_path":"D:/asr-gold/lesson-001/0001.wav","text":"תמלול נאמן לדיבור","split":"train","sha256":"64 lowercase hex characters","speaker_id":"speaker-01","source_id":"lesson-001","gold_source":"human_verified"}
```

Required fields are `id`, `audio_path`, `text`, `split`, `sha256`, `speaker_id`, `source_id`, and `gold_source`.
